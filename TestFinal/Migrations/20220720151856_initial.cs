    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_GroupClasses_GroupClassId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserSubscription", x => new { x.ApplicationUsersId, x.SubscriptionsId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserSubscription_AspNetUsers_ApplicationUsersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserTrainer", x => new { x.ApplicationUsersId, x.TrainersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserTrainer_AspNetUsers_ApplicationUsersId",
                        column: x => x.ApplicationUsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserTrainer_Trainer_TrainersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserTrainer_TrainersId",
